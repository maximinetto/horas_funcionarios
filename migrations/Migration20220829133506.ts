...
export class Migration20220829133506 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table `hourly_balance_teachers` (`id` varchar(36) not null, `created_at` datetime null, `updated_at` datetime null, `year` int not null, `balance` numeric(10,0) not null, `actual_balance_id` varchar(36) not null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;');
    ...
    this.addSql('create table `hourly_balances_tas` (`id` varchar(36) not null, `created_at` datetime null, `updated_at` datetime null, `year` int not null, `surplus_non_working` numeric(10,0) not null, `surplus_simple` numeric(10,0) not null, `surplus_business` numeric(10,0) not null, `actual_balance_id` varchar(36) not null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;');
    this.addSql('alter table `hourly_balances_tas` add index `hourly_balances_tas_actual_balance_id_index`(`actual_balance_id`);');

    this.addSql('create table `calculation_teachers` (`id` varchar(36) not null, `created_at` datetime null, `updated_at` datetime null, `year` int not null, `month` int not null, `observations` text null, `surplus` numeric(10,0) not null, `discount` numeric(10,0) not null, `actual_balance_id` varchar(36) not null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;');
    this.addSql('alter table `calculation_teachers` add index `calculation_teachers_actual_balance_id_index`(`actual_balance_id`);');

    this.addSql('create table `calculation_tas` (`id` varchar(36) not null, `created_at` datetime null, `updated_at` datetime null, `year` int not null, `month` int not null, `observations` text null, `surplus_business` numeric(10,0) not null, `surplus_non_working` numeric(10,0) not null, `surplus_simple` numeric(10,0) not null, `discount` numeric(10,0) not null, `working_overtime` numeric(10,0) not null, `working_night_overtime` numeric(10,0) not null, `non_working_overtime` numeric(10,0) not null, `non_working_night_overtime` numeric(10,0) not null, `compensated_night_overtime` numeric(10,0) not null, `actual_balance_id` varchar(36) not null, primary key (`id`)) default character set utf8mb4 engine = InnoDB;');
